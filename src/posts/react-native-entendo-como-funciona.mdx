...
## Estrutura
**“O React Native permite que os desenvolvedores que conhecem React criem aplicativos nativos.”**, é assim que somos inicialmente apresentados a esse framework na página [Get Started with React Native](https://reactnative.dev/docs/environment-setup) da doc oficial.
...
Para entender um pouco mais de React, recomendo ler essa seção sobre [Fundamentos do React](https://reactnative.dev/docs/intro-react) lá na doc oficial. Ela oferece uma boa introdução ao React no contexto do React Native.
## Arquitetura
...
Com essa nova arquitetura, o combo **Fabric** e **Turbo Modules** vão permitir que o **JavaScript** mantenha uma **referência direta** aos componentes e módulos nativos, reduzindo bastante a comunicação assíncrona da Bridge e melhorando significativamente a performance do app.
...
## Finalizando
É isso! Esta foi uma visão mais superficial sobre o funcionamento do React Native. Não me aprofundei em alguns conceitos e, alguns tópicos, como as *threads* e a *Shadow Tree*... acredito que merecem um artigo dedicado no futuro.

Mas pretendo escrever mais sobre isso em breve.
